...
namespace King {
	...
	float Engine::GetMouseX2() const
	{
		return mPimpl->mMouseX2;
	}

	float Engine::GetMouseY2() const
	{
		return mPimpl->mMouseY2;
	}
	...
	SDL_Window* Engine::EngineImplementation::GetSDLRender()
	{
		return (mSdlWindow);
	}
}
